...
public class CHMSDatabase extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE cattle_profile(cuin integer PRIMARY KEY,cattle_image varchar(30),cattle_name varchar(20),cattle_policy varchar(20),age integer(3),weight double,no_of_child integer(3),mother_id integer,father_id integer,breed varchar(20),status varchar(20))");
    }
