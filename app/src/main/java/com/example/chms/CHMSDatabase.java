...
public class CHMSDatabase extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE insemination(ins_id integer PRIMARY KEY AUTOINCREMENT,cuin integer,date varchar(12),time varchar(12),type varchar(12),note text,h_id integer)");
